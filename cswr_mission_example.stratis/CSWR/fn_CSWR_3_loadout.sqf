...
switch _tag do {
    ...
    case "BLU": {
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED" in uppercase:
            [
                "U_BG_Guerrilla_6_1",                       // Infantry uniform (use "RANDOM" for each unit to use one option from the list CSWR_bluUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_B_T_Soldier_AR_F",                      // Marine uniform (use "RANDOM" for each unit to use one option from the list CSWR_bluUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_B_T_Soldier_F",                         // Paratroop uniform (use "RANDOM" for each unit to use one option from the list CSWR_bluUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_B_T_FullGhillie_tna_F",                      // Sniper uniform (use "RANDOM" for each unit to use one option from the list CSWR_bluUniformsToRandom)
                "",                      // Sniper helmet
                "",                      // Sniper goggles
    ...
    case "OPF": {
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED" in uppercase:
            [
                "U_O_R_Gorka_01_F",                       // Infantry uniform (use "RANDOM" for each unit to use one option from the list CSWR_opfUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_O_R_Gorka_01_camo_F",                      // Marine uniform (use "RANDOM" for each unit to use one option from the list CSWR_opfUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_O_FullGhillie_sard",                      // Sniper uniform (use "RANDOM" for each unit to use one option from the list CSWR_opfUniformsToRandom)
                "",                      // Sniper helmet
                "",                      // Sniper goggles
                "",                      // Sniper vest (cannot be "REMOVED")
                "",                      // Sniper backpack
    ...
    case "IND": {
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED" in uppercase:
            [
                "U_B_GEN_Commander_F",                       // Infantry uniform (use "RANDOM" for each unit to use one option from the list CSWR_indUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_B_GEN_Soldier_F",                      // Marine uniform (use "RANDOM" for each unit to use one option from the list CSWR_indUniformsToRandom)
        ...
        // Loadout replacement / empty ("") results no change. To force removal, type "REMOVED":
            [
                "U_I_GhillieSuit",                      // Sniper uniform (use "RANDOM" for each unit to use one option from the list CSWR_indUniformsToRandom)
                "",                      // Sniper helmet
                "",                      // Sniper goggles
                "",                      // Sniper vest (cannot be "REMOVED")
                "",                      // Sniper backpack
