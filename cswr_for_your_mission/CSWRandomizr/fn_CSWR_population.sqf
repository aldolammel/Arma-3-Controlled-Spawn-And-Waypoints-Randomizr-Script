...
[] spawn {
    ...
    if ( CSWR_isOnBLU && count CSWR_spwnsAllBLU > 0 ) then {
		...
		// Define each group and their features and destination.
            ...
            // Vehicles
            // [ Side; [Spawns: CSWR_spwnsBLU, CSWR_spwnsVehBLU, CSWR_spwnsHeliBLU, CSWR_spwnsParadropBLU]; Vehicle type; Initial crew behavior: _be_SAFE, _be_AWARE, _be_COMBAT, _be_STEALTH, _be_CHAOS; [Destination: _move_ANY, _move_PUBLIC, _move_RESTRICTED, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];

            [BLUFOR, [CSWR_spwnsBLU], CSWR_vehicle_BLU_light, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_vehicle;
            [BLUFOR, [CSWR_spwnsBLU], CSWR_vehicle_BLU_medium, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_vehicle;
            ...
            [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_light, _form_BLU_2, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            ...
            [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_heavy, _form_BLU_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_heavy, _form_BLU_1, _be_SAFE, [_move_ANY], [5]] call THY_fnc_CSWR_add_group;
            [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_medium, _form_BLU_1, _be_AWARE, [_move_ANY], [2]] call THY_fnc_CSWR_add_group;
    ...
    if ( CSWR_isOnOPF && count CSWR_spwnsAllOPF > 0 ) then {
        ...
        // Define each group and their features and destination.
            ...
            // Vehicles
            // [ Side; [Spawns: CSWR_spwnsOPF, CSWR_spwnsVehOPF, CSWR_spwnsHeliOPF, CSWR_spwnsParadropOPF]; Vehicle type; Initial crew behavior: _be_SAFE, _be_AWARE, _be_COMBAT, _be_STEALTH, _be_CHAOS; [Destination: _move_ANY, _move_PUBLIC, _move_RESTRICTED, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];
			
            [OPFOR, [CSWR_spwnsOPF], CSWR_vehicle_OPF_light, _be_AWARE, [_move_ANY], []] call THY_fnc_CSWR_add_vehicle;
            [OPFOR, [CSWR_spwnsOPF], CSWR_vehicle_OPF_medium, _be_AWARE, [_move_ANY], []] call THY_fnc_CSWR_add_vehicle;

            // Soldier groups
            // [ Side; [Spawns: CSWR_spwnsOPF, CSWR_spwnsVehOPF, CSWR_spwnsParadropOPF]; Group type; Group formation: _form_OPF_1, _form_OPF_2; Initial group behavior: _be_SAFE, _be_AWARE, _be_COMBAT, _be_STEALTH, _be_CHAOS; [Destination: _move_ANY, _move_PUBLIC, _move_RESTRICTED, _move_OCCUPY, _move_WATCH, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];
			
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_sniper, _form_OPF_1, _be_COMBAT, [_move_WATCH], []] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_light, _form_OPF_2, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_light, _form_OPF_2, _be_AWARE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            ...
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_medium, _form_OPF_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_medium, _form_OPF_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_heavy, _form_OPF_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_heavy, _form_OPF_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_heavy, _form_OPF_1, _be_SAFE, [_move_ANY], [5]] call THY_fnc_CSWR_add_group;
            [OPFOR, [CSWR_spwnsOPF], CSWR_group_OPF_medium, _form_OPF_1, _be_AWARE, [_move_ANY], [2]] call THY_fnc_CSWR_add_group;
    ...
    if ( CSWR_isOnIND && count CSWR_spwnsAllIND > 0 ) then {
        ...
        // DEFINING SIDE GROUPS: INDEPENDENT
        ...
        // Define each group and their features and destination.
            ...
            // Vehicles
            // [ Side; [Spawns: CSWR_spwnsIND, CSWR_spwnsVehIND, CSWR_spwnsHeliIND, CSWR_spwnsParadropIND]; Vehicle type; Initial crew behavior: _be_SAFE, _be_AWARE, _be_COMBAT, _be_STEALTH, _be_CHAOS; [Destination: _move_ANY, _move_PUBLIC, _move_RESTRICTED, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];
            ...
            // Soldier groups
            // [ Side; [Spawns: CSWR_spwnsIND, CSWR_spwnsVehIND, CSWR_spwnsParadropIND]; Group type; Group formation: _form_IND_1, _form_IND_2; Initial group behavior: _be_SAFE, _be_AWARE, _be_COMBAT, _be_STEALTH, _be_CHAOS; [Destination: _move_ANY, _move_PUBLIC, _move_RESTRICTED, _move_OCCUPY, _move_WATCH, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];
			
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_sniper, _form_IND_1, _be_COMBAT, [_move_WATCH], []] call THY_fnc_CSWR_add_group;
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_light, _form_IND_2, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_light, _form_IND_2, _be_AWARE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_light, _form_IND_1, _be_COMBAT, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            ...
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_heavy, _form_IND_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_heavy, _form_IND_1, _be_SAFE, [_move_ANY], [5]] call THY_fnc_CSWR_add_group;
            [INDEPENDENT, [CSWR_spwnsIND], CSWR_group_IND_medium, _form_IND_1, _be_AWARE, [_move_ANY], [2]] call THY_fnc_CSWR_add_group;
    ...
    if ( CSWR_isOnCIV && count CSWR_spwnsAllCIV > 0 ) then {
        ...
        // Define the number of people and vehicles of Civilian side.
            ...
            // People groups
            CSWR_group_CIV_light    = ["C_man_polo_1_F"];
            CSWR_group_CIV_medium   = ["C_man_polo_1_F", "C_man_polo_2_F"];
            CSWR_group_CIV_heavy    = ["C_man_polo_1_F", "C_man_polo_2_F", "C_man_polo_3_F", "C_man_polo_4_F"];
            ...
            // CSWR CORE > DONT TOUCH > Public variables:
            publicVariable "CSWR_vehicle_CIV_light"; publicVariable "CSWR_vehicle_CIV_medium"; publicVariable "CSWR_vehicle_CIV_heavy"; publicVariable "CSWR_vehicle_CIV_custom_1"; publicVariable "CSWR_vehicle_CIV_custom_2"; publicVariable "CSWR_vehicle_CIV_custom_3"; publicVariable "CSWR_vehicle_CIV_heli_light"; publicVariable "CSWR_vehicle_CIV_heli_heavy"; publicVariable "CSWR_group_CIV_light"; publicVariable "CSWR_group_CIV_medium"; publicVariable "CSWR_group_CIV_heavy"; publicVariable "CSWR_group_CIV_custom_1"; publicVariable "CSWR_group_CIV_custom_2"; publicVariable "CSWR_group_CIV_custom_3";
		
        // SPAWNING GROUPS: CIVILIAN
        // Define each group and their features and destination.

            // Vehicles
            // [ Side; [Spawns: CSWR_spwnsCIV, CSWR_spwnsVehCIV, CSWR_spwnsHeliCIV]; Vehicle type; Initial crew behavior: _be_SAFE, _be_AWARE, _be_CHAOS; [Destination: _move_PUBLIC, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];
			
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_vehicle_CIV_light, _be_CHAOS, [_move_PUBLIC], []] call THY_fnc_CSWR_add_vehicle;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_vehicle_CIV_light, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_vehicle;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_vehicle_CIV_heavy, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_vehicle;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_vehicle_CIV_medium, _be_AWARE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_vehicle;
			
            // People groups
            // [ Side; [Spawns: CSWR_spwnsCIV, CSWR_spwnsVehCIV, CSWR_spwnsParadropCIV]; Group type; Group formation: _form_CIV_1, _form_CIV_2; Initial group behavior: _be_SAFE, _be_AWARE, _be_CHAOS; [Destination: _move_PUBLIC, _move_OCCUPY, _move_HOLD]; [Spawn delay: timer, trigger activation, target status] ];
			
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_light, _form_CIV_1, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_light, _form_CIV_1, _be_AWARE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_light, _form_CIV_1, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_light, _form_CIV_1, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_light, _form_CIV_1, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_medium, _form_CIV_1, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_medium, _form_CIV_1, _be_SAFE, [_move_PUBLIC], []] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_medium, _form_CIV_1, _be_CHAOS, [_move_PUBLIC], [2]] call THY_fnc_CSWR_add_group;
            [CIVILIAN, [CSWR_spwnsCIV], CSWR_group_CIV_heavy, _form_CIV_2, _be_CHAOS, [_move_PUBLIC], [2]] call THY_fnc_CSWR_add_group;
