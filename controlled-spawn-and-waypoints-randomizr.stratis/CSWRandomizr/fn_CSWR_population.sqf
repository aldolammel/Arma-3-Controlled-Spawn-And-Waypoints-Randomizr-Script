...
[] spawn {
    ...
    if ( CSWR_isOnBLU && count CSWR_spwnsAllBLU > 0 ) then {
		...
		// Define each group and their features and destination.
            ...
            /* [BLUFOR, [CSWR_spwnsBLU, "A"], CSWR_vehicle_BLU_light, _be_AWARE, [_move_ANY], []] call THY_fnc_CSWR_add_vehicle;
            ...
            [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_light, _form_BLU_1, _be_SAFE, [_move_RESTRICTED], []] call THY_fnc_CSWR_add_group;  // deletar
            [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_light, _form_BLU_1, _be_SAFE, [_move_ANY], []] call THY_fnc_CSWR_add_group;  // deletar
           ...
           /*  [BLUFOR, [CSWR_spwnsBLU], CSWR_group_BLU_sniper, _form_BLU_1, _be_COMBAT, [_move_WATCH], []] call THY_fnc_CSWR_add_group;
            [BLUFOR, [CSWR_spwnsBLU, "A"], CSWR_group_BLU_light, _form_BLU_2, _be_SAFE, [_move_RESTRICTED, "A"], []] call THY_fnc_CSWR_add_group;
