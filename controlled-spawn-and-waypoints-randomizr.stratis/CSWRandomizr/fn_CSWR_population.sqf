...
[] spawn {
	...
	if ( CSWR_isOnBLU && count CSWR_spwnsAllBLU > 0 ) then {
		...
		// Define each group and their features and destination.
			...
			[BLUFOR, CSWR_spwnsParadropBLU, CSWR_group_BLU_heavy, _form_BLU_2, _be_SAFE, _move_OCCUPY, []] call THY_fnc_CSWR_add_group;  // DELETARAAAAA
			[BLUFOR, CSWR_spwnsParadropBLU, CSWR_group_BLU_heavy, _form_BLU_1, _be_SAFE, _move_OCCUPY, []] call THY_fnc_CSWR_add_group;  // DELETARAAAAA
