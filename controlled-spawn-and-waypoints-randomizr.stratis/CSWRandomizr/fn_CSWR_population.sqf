...
[] spawn {
	...
	if ( CSWR_isOnCIV && count CSWR_spwnsAllCIV > 0 ) then {
		...
		// Define each group and their features and destination.
			...
			// Vehicles
			// [ owner, spawns (CSWR_spwnsCIV, CSWR_spwnsVehCIV, CSWR_spwnsHeliCIV), vehicle type, initial crew behavior (_be_SAFE, _be_AWARE, _be_CHAOS), destination (_move_PUBLIC, _move_HOLD), spawn delay (in minutes, or a list of triggers or targets. Check the documentation) ]
			...
			// People groups
			// [ owner, spawns (CSWR_spwnsCIV, CSWR_spwnsVehCIV, CSWR_spwnsParadropCIV), team type, team formation (_form_CIV_1, _form_CIV_2), initial team behavior (_be_SAFE, _be_AWARE, _be_CHAOS), destination (_move_PUBLIC, _move_OCCUPY, _move_HOLD), spawn delay (in minutes, or a list of triggers or targets. Check the documentation) ]
